	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_modify_contact_submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				name = editText_modify_contact_name_value.getText().toString();
				...
				homePhoneNumber = "";
				homePhoneNumber = editText_modify_contact_homePhoneNumber_value.getText().toString();
				mobilePhoneNumber = "";
				mobilePhoneNumber = editText_modify_contact_mobilePhoneNumber_value.getText().toString();
				otherPhoneNumber = "";
				otherPhoneNumber = editText_mofidy_contact_otherPhoneNumber_value.getText().toString();
				category = "";
